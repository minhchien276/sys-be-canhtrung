    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3" style="display: flex; align-items: center;">
                ...
                <a href="{{ route('product.list-categories') }}" style="margin-right: 20px" class="btn btn-primary">Danh sách
                    loại sản phẩm</a>

                <a href="{{ route('product.create-category') }}" style="margin-right: 20px" class="btn btn-primary">Tạo mới
                    loại sản phẩm</a>

                <a href="{{ route('product.create') }}" class="btn btn-primary">Tạo mới sản phẩm</a>
