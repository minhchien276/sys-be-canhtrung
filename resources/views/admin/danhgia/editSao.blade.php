    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary" style="flex: 1;">Cập nhật sao cho tư vấn viên {{ $tvv->tenTvv }}</h6>

                <div class="card-body">
                    <form action="{{ route('update.sao', ['id' => $tvv->maTvv]) }}" method="POST">
                        @csrf
