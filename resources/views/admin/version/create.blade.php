    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary" style="flex: 1;">Cập nhật phiên bản</h6>
                    ...
                    <form action="{{ route('version.store') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="version_id">Version_id:</label>
                                <input type="text" id="version_id" class="form-control" name="version_id">
                                @error('version_id')
